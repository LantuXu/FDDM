...
class gen_class(nn.Module):
    def __init__(
            ...
            FID_score=False,      # 是否在训练过程中评估FID分数
            FID_step=5,           # 每隔几个epoch评估一次FID分数
            FID_num=50,           # 每次FID评估几张图像
            FID_model_path="",    # FID所用模型的位置

            CLIP_score = False,   # 是否在训练过程中评估CLIP分数
            CLIP_step = 10,       # 每隔几个epoch评估一次CLIP分数
            CLIP_num=50,          # 每次CLIP评估几张图像
        ...
        self.FID_score = FID_score  # 是否在训练过程中评估FID分数
        self.FID_step = FID_step  # 每隔几千张图片评估一次FID分数
        self.FID_num = FID_num  # 每次FID评估几张图像
        self.FID_model_path = FID_model_path

        self.CLIP_score = CLIP_score  # 是否在训练过程中评估CLIP分数
        self.CLIP_step = CLIP_step  # 每隔几千张图片评估一次CLIP分数
        self.CLIP_num = CLIP_num  # 每次CLIP评估几张图像
